  ...
  <div id="tiku">
    <swiper :options="swiperOption" ref="mySwiper">
      ...
      <swiper-slide>
        ...
        <!--开始背题-->
        <div class="card-btn">
          <button class="btn begin" @click="clickCardBtn($event)">
